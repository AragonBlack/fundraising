...
module.exports = async (callback) => {
  console.log(`Deploying Fundraising Kit, Owner ${process.env.OWNER}`)
  ...
  await deploy_kit(null, { artifacts, kitName: 'kit-aragon-fundraising', kitContractName: 'FundraisingKit', network: network, ensAddress: ens.address })
}

      ...
      <Container overlay={this.props.overlay}>
        {!this.props.hideYearSelector && (
          <Selector>
            ...
            <Text size="normal">{formatDate(selected, this.props.yearFormat)}</Text>
        ...
        {!this.props.hideMonthSelector && (
          <Selector>
            ...
            <Text size="large" weight="bold">
              {formatDate(selected, !this.props.hideYearSelector ? this.props.monthFormat : this.props.monthYearFormat)}
            </Text>
          ...
          {!this.props.hideWeekDays &&
            eachDayOfInterval({
              ...
              <WeekDay key={formatDate(day, 'eeeeee')}>
                <Text size="xsmall">{formatDate(day, this.props.weekDayFormat)}</Text>
              </WeekDay>
            ))}

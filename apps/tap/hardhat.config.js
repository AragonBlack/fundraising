...
module.exports = {
  ...
  aragon: {
    ...
    appRoles: [
      ...
      {
        "name": "Update max tap rate increase percentage",
        "id": "UPDATE_MAXIMUM_TAP_RATE_INCREASE_PCT_ROLE",
        "params": []
      },
      {
        "name": "Update max tap rate floor decrease percentage role",
        "id": "UPDATE_MAXIMUM_TAP_FLOOR_DECREASE_PCT_ROLE",
        "params": []
      },
      {
        "name": "Add tapped token",
        "id": "ADD_TAPPED_TOKEN_ROLE",
        "params": []
      },
      {
        "name": "Remove tapped token",
        "id": "REMOVE_TAPPED_TOKEN_ROLE",
        "params": []
      },
      {
        "name": "Update tapped token",
        "id": "UPDATE_TAPPED_TOKEN_ROLE",
        "params": []
      },
      {
        "name": "Rset tapped token",
